...
console.log(foundLicencia );
  ...
  return (
    <div className='w-full h-screen flex flex-col'>
      ...
      <div className='w-full h-screen bg-no-repeat  bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Chihuahua%2Ftextura.jpg?alt=media&token=1ab6354b-24af-435a-a0dd-63066120e61a")] sm:bg-center sm:bg-no-repeat sm:bg-cover lg:bg-repeat lg:bg-contain lg:bg-center flex flex-col items-center py-[4rem] sm:gap-5 gap-10'>
