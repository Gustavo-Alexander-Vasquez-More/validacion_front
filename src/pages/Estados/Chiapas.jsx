...
console.log(foundLicencia );
  ...
  return (
    <div className='w-full h-screen flex flex-col'>
      ...
      <div className='w-full h-screen bg-no-repeat  bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Chiapas%2Ftextura.jpg?alt=media&token=395a671f-0ba1-4e51-a539-e1312ee15a23")] sm:bg-center sm:bg-no-repeat sm:bg-cover lg:bg-repeat lg:bg-contain lg:bg-center flex flex-col items-center py-[4rem] sm:gap-5 gap-10'>
