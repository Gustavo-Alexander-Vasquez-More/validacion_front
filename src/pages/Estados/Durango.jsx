...
async function navigateValidation() {
  ...
  return (
    ...
    <div className='w-full h-[8vh] bg-[#363636] flex items-center justify-end px-[2rem]'>
      <p className=' text-[white] font-medium'>Durango - Gobierno del Estado.</p>
    </div>
    <div className='w-full h-[96vh]  bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Durango%2Ftextura.jpg?alt=media&token=628148f3-b324-4186-8746-b160e8df16c0")] sm:bg-center sm:bg-no-repeat sm:bg-cover lg:bg-repeat lg:bg-contain lg:bg-center flex flex-col items-center py-[4rem] gap-5'>
      <img className='lg:w-[25rem] sm:w-[20rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Durango%2Flogo.png?alt=media&token=ab6d40e2-cb61-4191-9e49-fb3035d68ebe" alt="" />
