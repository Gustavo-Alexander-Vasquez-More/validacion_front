...
async function navigateValidation() {
  ...
  return (
    ...
    <div className='w-full h-[8vh] bg-[#818080] flex items-center justify-end px-[2rem]'>
    ...
    <img className='w-[25rem]'  src="/public/Durango/logo.png" alt="" />
    <div className='bg-[white] border-solid border-[1px] border-[#818080] w-[30%] h-auto justify-around py-[1rem] px-[1.5rem] rounded-[10px] flex flex-col gap-5'>
    ...
    <button onClick={navigateValidation} className='bg-[#818080] rounded-[10px] text-[white] py-[0.5rem]'>Buscar</button>    
    </div>
    </div>
    </div>
  );
