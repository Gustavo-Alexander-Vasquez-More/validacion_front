...
async function navigateValidation() {
  ...
  return (
    ...
    <div className='w-full h-[96vh]  bg-[url("/public/Durango/textura.jpg")] sm:bg-center sm:bg-no-repeat sm:bg-cover lg:bg-repeat lg:bg-contain lg:bg-center flex flex-col items-center py-[4rem] gap-5'>
      <img className='lg:w-[25rem] sm:w-[20rem]' src="/public/Durango/logo.png" alt="" />
