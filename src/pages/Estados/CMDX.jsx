...
console.log(foundLicencia );
  ...
  return (
    <div className='w-full h-screen flex flex-col'>
      <div className='w-full h-[8vh] bg-[#9e273b] flex items-center justify-end px-[2rem]'>
        <p className=' text-[white] font-medium'>Ciudad De México - Gobierno del Estado.</p>
      </div>
      <div className='w-full h-[96vh]  bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/CDMX%2Ftextura.jpg?alt=media&token=43aeb597-c965-491d-86f7-dc7b213dfad4")] sm:bg-center sm:bg-no-repeat sm:bg-cover lg:bg-repeat lg:bg-contain lg:bg-center flex flex-col items-center py-[4rem] gap-5'>
        <img className='lg:w-[20rem] sm:w-[20rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/CDMX%2Flogo.png?alt=media&token=cd8cfd44-f114-43c7-800b-7708071e752a" alt="" />
