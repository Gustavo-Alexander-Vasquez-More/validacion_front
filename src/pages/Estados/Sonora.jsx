...
async function navigateValidation() {
  ...
  return (
    ...
    <div className='w-full h-[8vh] bg-[#751e1e] flex items-center justify-end px-[2rem]'>
      <p className=' text-[white] font-medium'>Sonora - Gobierno del Estado.</p>
    </div>
    <div className='w-full h-[96vh]  bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Sonora%2Ftextura.jpg?alt=media&token=fe661537-ddb5-4476-ad1f-2d9822098eea")] sm:bg-center sm:bg-no-repeat sm:bg-cover lg:bg-repeat lg:bg-contain lg:bg-center flex flex-col items-center py-[4rem] gap-5'>
      <img className='lg:w-[20rem] sm:w-[20rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Sonora%2Flogo.png?alt=media&token=c4ab767c-11ac-40d1-bea9-c674a66e97c5" alt="" />
