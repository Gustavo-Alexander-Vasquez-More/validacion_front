...
async function navigateValidation() {
  ...
  return (
    ...
    <p className=' text-[white] font-medium'>San Luis Potosí - Gobierno del Estado.</p>
    </div>
    <div className='w-full h-[96vh] bg-[url("/public/Guerrero/textura.jpg")] bg-contain bg-center flex flex-col items-center py-[2rem] gap-7'>
    <img className='w-[16rem]'  src="/public/SanLuisPotosi/logo.png" alt="" />
    ...
    <button onClick={navigateValidation} className='bg-[#1f1f70] rounded-[10px] text-[white] py-[0.5rem]'>Buscar</button>    
    </div>
    </div>
    </div>
  );
