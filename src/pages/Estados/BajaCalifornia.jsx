...
console.log(foundLicencia );
  ...
  return (
    <div className='w-full h-screen flex flex-col'>
      <div className='w-full h-[8vh] bg-[#701f2c] flex items-center justify-end px-[2rem]'>
        <p className=' text-[white] font-medium'>Baja California Norte  - Gobierno del Estado.</p>
      </div>
      <div className='w-full h-[96vh]  bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/BajaCaliforniaNorte%2Ftextura.jpg?alt=media&token=d40631bd-6c1c-4b30-a825-419cedaa7433")] sm:bg-center sm:bg-no-repeat sm:bg-cover lg:bg-repeat lg:bg-contain lg:bg-center flex flex-col items-center py-[4rem] gap-5'>
        <img className='lg:w-[25rem] sm:w-[15rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/BajaCaliforniaNorte%2Flogo.png?alt=media&token=3ae04f98-5656-4fe8-88da-15449a157ab2" alt="" />
