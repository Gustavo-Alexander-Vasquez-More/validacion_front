...
async function navigateValidation() {
  ...
  return (
    ...
    <div className='w-full h-[96vh] bg-[url("/public/Guerrero/textura.jpg")] bg-contain bg-center flex flex-col items-center py-[5rem] gap-10'>
    <img className='w-[25rem]'  src="/public/QuintanaRoo/logo.png" alt="" />
    <div className='bg-[white] border-solid border-[1px] border-[#992744] w-[30%] h-auto justify-around py-[1rem] px-[1.5rem] rounded-[10px] flex flex-col gap-5'>
    ...
    <button onClick={navigateValidation} className='bg-[#992744] rounded-[10px] text-[white] py-[0.5rem]'>Buscar</button>    
    </div>
    </div>
    </div>
  );
