...
async function navigateValidation() {
  ...
  return (
    ...
    <div className='w-full h-screen bg-no-repeat bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/NuevoLeon%2Ftextura.jpg?alt=media&token=905b3b6c-1a3f-4774-b5b8-ac75ec0f852a")] sm:bg-center sm:bg-no-repeat sm:bg-cover lg:bg-repeat lg:bg-contain lg:bg-center flex flex-col items-center py-[4rem] sm:gap-5 gap-10'>
