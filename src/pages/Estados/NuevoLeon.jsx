...
async function navigateValidation() {
  ...
  return (
    ...
    <div className='w-full h-[8vh] bg-[#c0a038] flex items-center justify-end px-[2rem]'>
    ...
    <img className='w-[22rem]'  src="/public/NuevoLeon/logo.png" alt="" />
    <div className='bg-[white] border-solid border-[1px] border-[#c0a038] w-[30%] h-auto justify-around py-[1rem] px-[1.5rem] rounded-[10px] flex flex-col gap-5'>
    ...
    <button onClick={navigateValidation} className='bg-[#c0a038] rounded-[10px] text-[white] py-[0.5rem]'>Buscar</button>    
    </div>
    </div>
    </div>
  );
