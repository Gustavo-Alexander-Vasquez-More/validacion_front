...
async function navigateValidation() {
  ...
  return (
    <div className='w-full h-screen flex flex-col'>
      <div className='w-full h-[8vh] bg-[#631828] flex items-center justify-end px-[2rem]'>
        <p className=' text-[white] font-medium'>Colima - Gobierno del Estado.</p>
      </div>
      <div className='w-full h-[96vh]  bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Colima%2Ftextura.jpg?alt=media&token=27da4400-5ae4-4d0c-bb8d-8ef4841719c7")] sm:bg-center sm:bg-no-repeat sm:bg-cover lg:bg-repeat lg:bg-contain lg:bg-center flex flex-col items-center py-[4rem] gap-5'>
        <img className='lg:w-[25rem] sm:w-[20rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Colima%2Flogo.png?alt=media&token=44f811a0-d99e-40f5-8569-8256e3f0d16d" alt="" />
