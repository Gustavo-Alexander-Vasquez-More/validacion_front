...
async function navigateValidation() {
  ...
  return (
    ...
    <div className='w-full h-screen bg-no-repeat  bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Edomex%2Ftextura.jpg?alt=media&token=9c5ec205-ba14-4382-9556-2a57d47aa6a9")] sm:bg-center sm:bg-no-repeat sm:bg-cover lg:bg-repeat lg:bg-contain lg:bg-center flex flex-col items-center py-[4rem] sm:gap-5  gap-10'>
