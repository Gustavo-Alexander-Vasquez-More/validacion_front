...
console.log(foundLicencia );
  ...
  return (
    <div className='w-full h-screen flex flex-col'>
      <div className='w-full h-[8vh] bg-[#186322] flex items-center justify-end px-[2rem]'>
        <p className=' text-[white] font-medium'>Coahuila - Gobierno del Estado.</p>
      </div>
      <div className='w-full h-[96vh]  bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Coahuila%2Ftextura.jpg?alt=media&token=956cfbba-4c8a-41d0-bbbb-46fd9a5e5212")] sm:bg-center sm:bg-no-repeat sm:bg-cover lg:bg-repeat lg:bg-contain lg:bg-center flex flex-col items-center py-[4rem] gap-5'>
        <img className='lg:w-[25rem] sm:w-[20rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Coahuila%2Flogo.png?alt=media&token=4fa6156b-cf24-4180-ac88-f6e8624879e4" alt="" />
