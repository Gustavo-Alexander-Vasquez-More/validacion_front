...
async function navigateValidation() {
  ...
  return (
    ...
    <div className='w-full h-[96vh]  bg-[url("/public/Zacatecas/textura.jpg")] sm:bg-center sm:bg-no-repeat sm:bg-cover lg:bg-repeat lg:bg-contain lg:bg-center flex flex-col items-center py-[4rem] gap-5'>
      <img className='lg:w-[20rem] sm:w-[15rem]' src="/public/Zacatecas/logo.png" alt="" />
