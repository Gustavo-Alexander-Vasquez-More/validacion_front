...
async function navigateValidation() {
  ...
  return (
    ...
    <div className='w-full h-screen bg-no-repeat bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Zacatecas%2Ftextura.jpg?alt=media&token=bd856a8b-662b-4c4b-82ca-c5b120052d98")] sm:bg-center sm:bg-no-repeat sm:bg-cover lg:bg-repeat lg:bg-contain lg:bg-center flex flex-col items-center py-[4rem] sm:gap-5 gap-10'>
