...
async function navigateValidation() {
  ...
  return (
    ...
    <div className='w-full h-[8vh] bg-[#b62f2f] flex items-center justify-end px-[2rem]'>
      <p className=' text-[white] font-medium'>Zacatecas - Gobierno del Estado.</p>
    </div>
    <div className='w-full h-[96vh]  bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Zacatecas%2Ftextura.jpg?alt=media&token=bd856a8b-662b-4c4b-82ca-c5b120052d98")] sm:bg-center sm:bg-no-repeat sm:bg-cover lg:bg-repeat lg:bg-contain lg:bg-center flex flex-col items-center py-[4rem] gap-5'>
      <img className='lg:w-[20rem] sm:w-[15rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Zacatecas%2Flogo.png?alt=media&token=a5bd3d37-3874-468b-a3ca-cd7d897da6e4" alt="" />
