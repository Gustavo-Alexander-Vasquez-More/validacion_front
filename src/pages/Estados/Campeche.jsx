...
export default function Campeche() {
  return (
    ...
    <div className='w-full h-[96vh] bg-[url("/public/AguasCalientes/textura.jpg")] bg-contain bg-center flex flex-col items-center py-[4rem] gap-[3rem]'>
    <img className='w-[25rem]'  src="/public/Campeche/logo.png" alt="" />
