...
console.log(foundLicencia );
  ...
  return (
    <div className='w-full h-screen flex flex-col'>
      ...
      <div className='w-full h-screen bg-no-repeat  bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Campeche%2Ftextura.jpg?alt=media&token=c43e0dca-a251-4247-a003-3a77167b2e71")] sm:bg-center sm:bg-no-repeat sm:bg-cover lg:bg-repeat lg:bg-contain lg:bg-center flex flex-col items-center py-[4rem] sm:gap-5 gap-10'>
