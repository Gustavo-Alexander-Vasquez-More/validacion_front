...
export default function durangoVal() {
  ...
  return (
    ...
    <img className='lg:w-[18rem] sm:w-[10rem]  h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Durango%2Flogo.png?alt=media&token=ab6d40e2-cb61-4191-9e49-fb3035d68ebe" alt="" />
    </div>
