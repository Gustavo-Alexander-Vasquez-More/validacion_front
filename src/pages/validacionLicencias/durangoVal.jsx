...
export default function durangoVal() {
  ...
  return (
    ...
    <img className='w-[20rem] h-[7rem]' src="../../public/Durango/logo.png" alt="" />
    </div>
    ...
    <div className='w-full h-[5vh]  text-[#424242] flex justify-center items-center text-[1.2rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
    ...
    <p className='text-[#424242]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#424242]'>FOLIO / TIPO</p>
    ...
    <p className='text-[#424242]'>TIPO</p>
    ...
    <p className='text-[#424242]'>RFC / CURP</p>
    ...
    <p className='text-[#424242]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#424242]'>VIGENCIA</p>
    ...
    <p className='text-[#424242] text-[2rem]'>Validación de licencias de conducir</p>
