...
export default function michoacanVal() {
    ...
    return (
      ...
      <img className='w-[20rem] h-[7rem]' src="../../public/Michoacan/logo.png" alt="" />
      </div>
      ...
      <div className='w-full h-[5vh]  text-[#a03434] flex justify-center items-center text-[1.2rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
      ...
      <p className='text-[#a03434]'>NOMBRE COMPLETO</p>
      ...
      <p className='text-[#a03434]'>FOLIO / TIPO</p>
      ...
      <p className='text-[#a03434]'>TIPO</p>
      ...
      <p className='text-[#a03434]'>RFC / CURP</p>
      ...
      <p className='text-[#a03434]'>FECHA DE EXPEDICIÓN</p>
      ...
      <p className='text-[#a03434]'>VIGENCIA</p>
      ...
      <div className='bg-[url("/public/Michoacan/2.png")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
      </div>
      ...
      <p className='text-[#a03434] text-[2rem]'>Validación de licencias de conducir</p>
      <img className='w-[15rem]' src="../../public/Michoacan/logo.png" alt="" />
      </div>
      </div>
