...
export default function michoacanVal() {
    ...
    <img className='lg:w-[18rem] sm:w-[10rem]  h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Michoacan%2Flogo.png?alt=media&token=c079c559-455e-4784-a661-374cd2317e5a" alt="" />
    </div>
