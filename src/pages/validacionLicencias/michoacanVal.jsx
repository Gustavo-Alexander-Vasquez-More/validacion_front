...
export default function michoacanVal() {
    ...
    const folio = useParams();
      ...
      const licenciaEncontrada = licenciaMichoacan.find((item) => item.folio === folio.folio);
    ...
    <img className='lg:w-[18rem] sm:w-[15rem]  h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Michoacan%2Flogo.png?alt=media&token=c079c559-455e-4784-a661-374cd2317e5a" alt="" />
    </div>
    ...
    <p className='text-[#962e2e] sm:text-[1rem] text-[0.8rem]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#962e2e] sm:text-[1rem] text-[0.8rem]'>FOLIO</p>
    ...
    <p className='text-[#962e2e] sm:text-[1rem] text-[0.8rem]'>TIPO</p>
    ...
    <p className='text-[#962e2e] sm:text-[1rem] text-[0.8rem]'>RFC / CURP</p>
    ...
    <p className='text-[#962e2e] sm:text-[1rem] text-[0.8rem]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#962e2e] sm:text-[1rem] text-[0.8rem]'>VIGENCIA</p>
    ...
    <div className='bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Michoacan%2F2.png?alt=media&token=099bb959-6064-4d65-acd3-04010a31450b")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <img className='w-[15rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Michoacan%2Flogo.png?alt=media&token=c079c559-455e-4784-a661-374cd2317e5a" alt="" />
    </div>
    </div>
