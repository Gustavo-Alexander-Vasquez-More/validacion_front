...
export default function edomexVal() {
  ...
  return (
    ...
    <img className='lg:w-[18rem] sm:w-[10rem]  h-[6rem]' src="../../public/Edomex/logo.png" alt="" />
    </div>
    ...
    <div className='bg-[url("/public/Edomex/2.png")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <img className='w-[15rem]' src="../../public/Edomex/logo.png" alt="" />
    </div>
    </div>
