...
export default function edomexVal() {
    ...
    if(rol === '3'){
      ...
      const licenciaEncontrada = licenciaEdomex?.find((item) => item.folio === folio);
  ...
  return (
    ...
    <img className='lg:w-[18rem] sm:w-[10rem]  h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Edomex%2Flogo.png?alt=media&token=a77ff048-b0b8-4a7e-9b53-a57a1b00f414" alt="" />
    </div>
    ...
    <div className='w-full h-[5vh]  text-[#494949] flex justify-center items-center text-[1.2rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
    ...
    <p className='text-[#494949] sm:text-[1rem] text-[0.8rem]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#494949] sm:text-[1rem] text-[0.8rem]'>FOLIO</p>
    ...
    <p className='text-[#494949] sm:text-[1rem] text-[0.8rem]'>TIPO</p>
    ...
    <p className='text-[#494949] sm:text-[1rem] text-[0.8rem]'>RFC / CURP</p>
    ...
    <div className='bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Edomex%2F2.png?alt=media&token=3ace3c9b-4569-4730-9e89-efd20588e186")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <p className='text-[#494949] lg:text-[1.5rem]'>Validación de licencias de conducir</p>
    <img className='w-[15rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Edomex%2Flogo.png?alt=media&token=a77ff048-b0b8-4a7e-9b53-a57a1b00f414" alt="" />
    </div>
    </div>
    {token && (
