...
export default function edomexVal() {
  ...
  return (
    ...
    <p className='text-[#494949]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#494949]'>FOLIO</p>
    ...
    <p className='text-[#494949]'>TIPO</p>
    ...
    <p className='text-[#494949]'>RFC / CURP</p>
    ...
    <p className='text-[#494949]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#494949]'>VIGENCIA</p>
