...
export default function colimaVal() {
  ...
  return (
    ...
    <img className='lg:w-[18rem] sm:w-[10rem]  h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Colima%2Flogo.png?alt=media&token=44f811a0-d99e-40f5-8569-8256e3f0d16d" alt="" />
    </div>
    ...
    <div className='bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Colima%2F2.png?alt=media&token=201a047f-e8d0-4e27-8e3c-b30c652273c0")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
