...
export default function colimaVal() {
  ...
  return (
    ...
    <img className='w-[20rem] h-[7rem]' src="../../public/Colima/logo.png" alt="" />
    </div>
    ...
    <div className='bg-[url("/public/Colima/2.png")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <img className='w-[15rem]' src="../../public/Colima/logo.png" alt="" />
    </div>
    </div>
