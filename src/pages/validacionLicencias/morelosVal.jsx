...
export default function morelos() {
  ...
  return (
    ...
    <p className='text-[#414040]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#414040]'>FOLIO</p>
    ...
    <p className='text-[#414040]'>TIPO</p>
    ...
    <p className='text-[#414040]'>RFC / CURP</p>
    ...
    <p className='text-[#414040]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#414040]'>VIGENCIA</p>
