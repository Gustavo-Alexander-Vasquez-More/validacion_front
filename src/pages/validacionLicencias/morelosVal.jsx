...
export default function morelos() {
  ...
  const folio = useParams();
    ...
    const licenciaEncontrada = licenciaMorelos.find((item) => item.folio === folio.folio);
  ...
  return (
    ...
    <img className='lg:w-[35rem] sm:w-[20rem]  h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Morelos%2Flogo.png?alt=media&token=2d382bbc-de88-4b33-b21d-f318568a9904" alt="" />
    </div>
    ...
    <div className='w-full h-[5vh]  text-[#414040] flex justify-center items-center text-[1.2rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
    ...
    <p className='text-[#414040] sm:text-[1rem] text-[0.8rem]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#414040] sm:text-[1rem] text-[0.8rem]'>FOLIO</p>
    ...
    <p className='text-[#414040] sm:text-[1rem] text-[0.8rem]'>TIPO</p>
    ...
    <p className='text-[#414040] sm:text-[1rem] text-[0.8rem]'>RFC / CURP</p>
    ...
    <p className='text-[#414040] sm:text-[1rem] text-[0.8rem]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#414040] sm:text-[1rem] text-[0.8rem]'>VIGENCIA</p>
    ...
    <div className='bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Morelos%2F2.png?alt=media&token=254a32bf-a38d-4bb2-9313-88e509d7eda8")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <p className='text-[#414040] lg:text-[1.5rem]'>Validación de licencias de conducir</p>
    <img className='lg:w-[30rem] sm:w-[80rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Morelos%2Flogo.png?alt=media&token=2d382bbc-de88-4b33-b21d-f318568a9904" alt="" />
    </div>
    </div>
