...
export default function morelos() {
  ...
  return (
    ...
    <img className='lg:w-[35rem] sm:w-[20rem]  h-[6rem]' src="../../public/Morelos/logo.png" alt="" />
    </div>
    ...
    <div className='bg-[url("/public/Morelos/2.png")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <img className='lg:w-[30rem] sm:w-[80rem]' src="../../public/Morelos/logo.png" alt="" />
    </div>
    </div>
