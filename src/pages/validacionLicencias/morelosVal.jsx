...
export default function morelos() {
  ...
  return (
    ...
    <img className='w-[30rem] h-[8rem]' src="../../public/Morelos/logo.png" alt="" />
    </div>
    ...
    <div className='w-full h-[5vh]  text-[#3a3939] flex justify-center items-center text-[1.2rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
    ...
    <p className='text-[#3a3939]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#3a3939]'>FOLIO / TIPO</p>
    ...
    <p className='text-[#3a3939]'>TIPO</p>
    ...
    <p className='text-[#3a3939]'>RFC / CURP</p>
    ...
    <p className='text-[#3a3939]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#3a3939]'>VIGENCIA</p>
    ...
    <p className='text-[#3a3939] text-[2rem]'>Validación de licencias de conducir</p>
    <img className='w-[20rem]' src="../../public/Morelos/logo.png" alt="" />
    </div>
    </div>
