...
export default function queretaroVal() {
  ...
  return (
    ...
    <p className='text-[#342683]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#342683]'>FOLIO</p>
    ...
    <p className='text-[#342683]'>TIPO</p>
    ...
    <p className='text-[#342683]'>RFC / CURP</p>
    ...
    <p className='text-[#342683]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#342683]'>VIGENCIA</p>
