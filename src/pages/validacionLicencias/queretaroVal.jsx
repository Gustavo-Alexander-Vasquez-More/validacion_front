...
export default function queretaroVal() {
  ...
  return (
    ...
    <img className='lg:w-[18rem] sm:w-[20rem]  h-[6rem]' src="../../public/Queretaro/logo.png" alt="" />
    </div>
    ...
    <div className='bg-[url("/public/Queretaro/2.png")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <img className='w-[25rem]' src="../../public/Queretaro/logo.png" alt="" />
    </div>
    </div>
