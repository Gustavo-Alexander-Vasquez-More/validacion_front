...
export default function queretaroVal() {
  ...
  return (
    ...
    <img className='w-[25rem] h-[7rem]' src="../../public/Queretaro/logo.png" alt="" />
    </div>
    ...
    <div className='w-full h-[5vh]  text-[#343b9b] flex justify-center items-center text-[1.2rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
    ...
    <p className='text-[#343b9b]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#343b9b]'>FOLIO / TIPO</p>
    ...
    <p className='text-[#343b9b]'>TIPO</p>
    ...
    <p className='text-[#343b9b]'>RFC / CURP</p>
    ...
    <p className='text-[#343b9b]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#343b9b]'>VIGENCIA</p>
    ...
    <p className='text-[#343b9b] text-[2rem]'>Validación de licencias de conducir</p>
    <img className='w-[20rem]' src="../../public/Queretaro/logo.png" alt="" />
    </div>
    </div>
