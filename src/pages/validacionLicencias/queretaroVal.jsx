...
export default function queretaroVal() {
    ...
    const folio = useParams();
      ...
      const licenciaEncontrada = licenciaQueretaro.find((item) => item.folio === folio.folio);
  ...
  return (
    ...
    <img className='lg:w-[18rem] sm:w-[20rem]  h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Queretaro%2Flogo.png?alt=media&token=0f8c7bb2-2cc3-4950-a426-7bbe1eb3e719" alt="" />
    </div>
    ...
    <div className='w-full h-[5vh]  text-[#342683] flex justify-center items-center text-[1.2rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
    ...
    <p className='text-[#342683] sm:text-[1rem] text-[0.8rem]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#342683] sm:text-[1rem] text-[0.8rem]'>FOLIO</p>
    ...
    <p className='text-[#342683] sm:text-[1rem] text-[0.8rem]'>TIPO</p>
    ...
    <p className='text-[#342683] sm:text-[1rem] text-[0.8rem]'>RFC / CURP</p>
    ...
    <p className='text-[#342683] sm:text-[1rem] text-[0.8rem]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#342683] sm:text-[1rem] text-[0.8rem]'>VIGENCIA</p>
    ...
    <div className='bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Queretaro%2F2.png?alt=media&token=4c157536-9129-4c03-b8a4-a94d3340b8d2")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <p className='text-[#342683] lg:text-[1.5rem]'>Validación de licencias de conducir</p>
