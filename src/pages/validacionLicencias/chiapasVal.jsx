...
function formatearFecha(fechaISO8601) {
  ...
  return (
    ...
    <img className='lg:w-[18rem] sm:w-[10rem]  h-[6rem]' src="../../public/Chiapas/logo.png" alt="" />
    </div>
    ...
    <p className='text-[#848d2f]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#848d2f]'>FOLIO</p>
    ...
    <p className='text-[#848d2f]'>TIPO</p>
    ...
    <p className='text-[#848d2f]'>RFC / CURP</p>
    ...
    <p className='text-[#848d2f]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#848d2f]'>VIGENCIA</p>
