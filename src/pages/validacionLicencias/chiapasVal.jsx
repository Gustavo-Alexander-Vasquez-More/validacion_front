...
export default function chiapasVal() {
...
const folio = useParams();
  ...
  const licenciaEncontrada = licenciaChiapas.find((item) => item.folio === folio.folio);
...
function formatearFecha(fechaISO8601) {
  ...
  return (
    ...
    <img className='w-[20rem] h-[7rem]' src="../../public/Chiapas/logo.png" alt="" />
    </div>
    ...
    <div className='w-full h-[5vh]  text-[#a8a641] flex justify-center items-center text-[1.2rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
    ...
    <p className='text-[#a8a641]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#a8a641]'>FOLIO / TIPO</p>
    ...
    <p className='text-[#a8a641]'>TIPO</p>
    ...
    <p className='text-[#a8a641]'>RFC / CURP</p>
    ...
    <p className='text-[#a8a641]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#a8a641]'>VIGENCIA</p>
    ...
    <div className='bg-[url("/public/Chiapas/2.png")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <p className='text-[#a8a641] text-[2rem]'>Validación de licencias de conducir</p>
    <img className='w-[15rem]' src="../../public/Chiapas/logo.png" alt="" />
    </div>
    </div>
