...
export default function cdmxVal() {
    ...
    <img className='lg:w-[18rem] sm:w-[10rem]  h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/CDMX%2Flogo.png?alt=media&token=cd8cfd44-f114-43c7-800b-7708071e752a" alt="" />
    </div>
    ...
    <div className='bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/CDMX%2F2.png?alt=media&token=760e4490-6930-471b-9dd8-a341e758553f")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <img className='w-[15rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/CDMX%2Flogo.png?alt=media&token=cd8cfd44-f114-43c7-800b-7708071e752a" alt="" />
    </div>
    </div>
