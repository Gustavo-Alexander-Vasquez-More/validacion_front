...
export default function jaliscoVal() {
  ...
  return (
    ...
    <img className='lg:w-[18rem] sm:w-[10rem]  h-[6rem]' src="../../public/Jalisco/logo.png" alt="" />
    </div>
    ...
    <div className='bg-[url("/public/Jalisco/2.png")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <img className='w-[15rem]' src="../../public/Jalisco/logo.png" alt="" />
    </div>
    </div>
