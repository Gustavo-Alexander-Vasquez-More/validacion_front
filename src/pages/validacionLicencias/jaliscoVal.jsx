...
export default function jaliscoVal() {
  ...
  const folio = useParams();
    ...
    const licenciaEncontrada = licenciaJalisco.find((item) => item.folio === folio.folio);
  ...
  return (
    ...
    <img className='lg:w-[18rem] sm:w-[10rem]  h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Jalisco%2Flogo.png?alt=media&token=904177e7-75e6-4186-a540-12c9086ae87b" alt="" />
    </div>
    ...
    <div className='w-full h-[5vh]  text-[#525251] flex justify-center items-center text-[1.2rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
    ...
    <p className='text-[#525251] sm:text-[1rem] text-[0.8rem]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#525251] sm:text-[1rem] text-[0.8rem]'>FOLIO</p>
    ...
    <p className='text-[#525251] sm:text-[1rem] text-[0.8rem]'>TIPO</p>
    ...
    <p className='text-[#525251] sm:text-[1rem] text-[0.8rem]'>RFC / CURP</p>
    ...
    <p className='text-[#525251] sm:text-[1rem] text-[0.8rem]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#525251] sm:text-[1rem] text-[0.8rem]'>VIGENCIA</p>
    ...
    <div className='bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Jalisco%2F2.png?alt=media&token=d82dfb40-b5ee-4acf-b5f9-060877ed8979")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <p className='text-[#525251] lg:text-[1.5rem]'>Validación de licencias de conducir</p>
    <img className='w-[15rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Jalisco%2Flogo.png?alt=media&token=904177e7-75e6-4186-a540-12c9086ae87b" alt="" />
    </div>
    </div>
