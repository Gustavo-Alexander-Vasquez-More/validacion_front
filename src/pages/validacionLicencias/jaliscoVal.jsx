...
export default function jaliscoVal() {
    ...
    const licenciaJalisco2=allLicencia?.filter(licencia=>licencia.estado_id.nombre === 'Jalisco')
    const licenciaEncontrada = licenciaJalisco?.find((item) => item.folio === folio);
    const licenciaEncontradaAll = licenciaJalisco2.find((item) => item.folio === folio);
