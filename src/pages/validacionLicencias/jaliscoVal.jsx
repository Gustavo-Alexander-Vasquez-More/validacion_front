...
export default function jaliscoVal() {
  ...
  return (
    ...
    <p className='text-[#525251]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#525251]'>FOLIO</p>
    ...
    <p className='text-[#525251]'>TIPO</p>
    ...
    <p className='text-[#525251]'>RFC / CURP</p>
    ...
    <p className='text-[#525251]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#525251]'>VIGENCIA</p>
