...
export default function guerreroVal() {
  ...
  return (
    ...
    <img className='w-[20rem] h-[7rem]' src="../../public/Guerrero/logo.png" alt="" />
    </div>
    ...
    <div className='w-full h-[5vh]  text-[#a84141] flex justify-center items-center text-[1.2rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
    ...
    <p className='text-[#a84141]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#a84141]'>FOLIO / TIPO</p>
    ...
    <p className='text-[#a84141]'>TIPO</p>
    ...
    <p className='text-[#a84141]'>RFC / CURP</p>
    ...
    <p className='text-[#a84141]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#a84141]'>VIGENCIA</p>
    ...
    <p className='text-[#a84141] text-[2rem]'>Validación de licencias de conducir</p>
