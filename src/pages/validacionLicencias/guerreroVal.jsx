...
export default function guerreroVal() {
  ...
  return (
    ...
    <img className='lg:w-[18rem] sm:w-[10rem]  h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Guerrero%2Flogo.png?alt=media&token=6fa48b01-42e0-44f6-947b-e58cd2256a64" alt="" />
    </div>
    ...
    <p className='text-[#922c42]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#922c42]'>FOLIO</p>
    ...
    <p className='text-[#922c42]'>TIPO</p>
    ...
    <p className='text-[#922c42]'>RFC / CURP</p>
    ...
    <p className='text-[#922c42]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#922c42]'>VIGENCIA</p>
