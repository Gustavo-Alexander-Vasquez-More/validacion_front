...
export default function oaxacaVal() {
    ...
    const folio = useParams();
      ...
      const licenciaEncontrada = licenciaOaxaca.find((item) => item.folio === folio.folio);
  ...
  return (
    ...
    <img className='lg:w-[18rem] sm:w-[15rem] w-[12rem] h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Oaxaca%2Flogo.png?alt=media&token=07ae08f3-2719-45a4-85af-c7bc8ec416f9" alt="" />
    </div>
    ...
    <div className='bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Oaxaca%2F2.png?alt=media&token=b0136685-6333-4b09-8db6-f898d8239fb7")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <img className='w-[15rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Oaxaca%2Flogo.png?alt=media&token=07ae08f3-2719-45a4-85af-c7bc8ec416f9" alt="" />
    </div>
    </div>
    {token && (
