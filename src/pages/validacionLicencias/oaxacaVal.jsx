...
export default function oaxacaVal() {
  ...
  return (
    ...
    <img className='lg:w-[18rem] sm:w-[10rem]  h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Oaxaca%2Flogo.png?alt=media&token=07ae08f3-2719-45a4-85af-c7bc8ec416f9" alt="" />
    </div>
