...
export default function sanLuisVal() {
  ...
  return (
    ...
    <img className='lg:w-[15rem] sm:w-[10rem]  h-[6rem]' src="../../public/SanLuisPotosi/logo.png" alt="" />
    </div>
    ...
    <div className='bg-[url("/public/SanLuisPotosi/2.png")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <img className='w-[7rem]' src="../../public/SanLuisPotosi/logo.png" alt="" />
    </div>
    </div>
