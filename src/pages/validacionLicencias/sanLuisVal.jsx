...
export default function sanLuisVal() {
  ...
  console.log(licenciaSanLuis);
    const licenciaEncontrada = licenciaSanLuis.find((item) => item.folio === folio.folio);
  ...
  return (
    ...
    <img className='lg:w-[15rem] sm:w-[10rem] w-[10rem] h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/SanLuisPotosi%2Flogo.png?alt=media&token=5aa6d680-8433-46f4-9c13-f8f3248bcb2e" alt="" />
    </div>
    ...
    <p className='text-[#2f388d] sm:text-[1rem] text-[0.8rem]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#2f388d] sm:text-[1rem] text-[0.8rem]'>FOLIO</p>
    ...
    <p className='text-[#2f388d] sm:text-[1rem] text-[0.8rem]'>TIPO</p>
    ...
    <p className='text-[#2f388d] sm:text-[1rem] text-[0.8rem]'>RFC / CURP</p>
    ...
    <p className='text-[#2f388d] sm:text-[1rem] text-[0.8rem]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#2f388d] sm:text-[1rem] text-[0.8rem]'>VIGENCIA</p>
    ...
    <div className='bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/SanLuisPotosi%2F2.png?alt=media&token=35c9a34d-c492-44b5-b845-6e4184d36756")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <img className='w-[7rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/SanLuisPotosi%2Flogo.png?alt=media&token=5aa6d680-8433-46f4-9c13-f8f3248bcb2e" alt="" />
    </div>
    </div>
    {token && (
