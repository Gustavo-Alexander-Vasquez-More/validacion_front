...
export default function sanLuisVal() {
  ...
  return (
    ...
    <img className='w-[15rem] h-[8rem]' src="../../public/SanLuisPotosi/logo.png" alt="" />
    </div>
    ...
    <div className='w-full h-[5vh]  text-[#323497] flex justify-center items-center text-[1.2rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
    ...
    <p className='text-[#323497]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#323497]'>FOLIO / TIPO</p>
    ...
    <p className='text-[#323497]'>TIPO</p>
    ...
    <p className='text-[#323497]'>RFC / CURP</p>
    ...
    <p className='text-[#323497]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#323497]'>VIGENCIA</p>
    ...
    <p className='text-[#323497] text-[2rem]'>Validación de licencias de conducir</p>
    <img className='w-[9rem]' src="../../public/SanLuisPotosi/logo.png" alt="" />
    </div>
    </div>
