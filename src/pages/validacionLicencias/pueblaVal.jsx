...
export default function pueblaVal() {
    ...
    if(rol === '3'){
      ...
      const licenciaPuebla2 = allLicencia?.filter(licencia => licencia.estado_id.nombre === 'Puebla');
      const licenciaEncontrada = licenciaPuebla?.find((item) => item.folio === folio);
      const licenciaEncontradaAll = licenciaPuebla2?.find((item) => item.folio === folio);
  ...
  return (
    ...
    <img className='lg:w-[18rem] sm:w-[10rem] w-[12rem] h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Puebla%2Flogo.png?alt=media&token=19755382-86fd-4f11-8ac9-686345b8a182" alt="" />
    </div>
