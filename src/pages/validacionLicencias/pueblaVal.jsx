...
export default function pueblaVal() {
  ...
  return (
    ...
    <img className='w-[25rem] h-[7rem]' src="../../public/Puebla/logo.png" alt="" />
    </div>
    ...
    <div className='w-full h-[5vh]  text-[#444343] flex justify-center items-center text-[1.2rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
    ...
    <p className='text-[#444343]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#444343]'>FOLIO / TIPO</p>
    ...
    <p className='text-[#444343]'>TIPO</p>
    ...
    <p className='text-[#444343]'>RFC / CURP</p>
    ...
    <p className='text-[#444343]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#444343]'>VIGENCIA</p>
    ...
    <p className='text-[#444343] text-[2rem]'>Validación de licencias de conducir</p>
    <img className='w-[17rem]' src="../../public/Puebla/logo.png" alt="" />
    </div>
    </div>
