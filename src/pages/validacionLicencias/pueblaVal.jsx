...
export default function pueblaVal() {
  ...
  return (
    ...
    <img className='lg:w-[18rem] sm:w-[10rem]  h-[6rem]' src="../../public/Puebla/logo.png" alt="" />
    </div>
    ...
    <div className='bg-[url("/public/Puebla/2.png")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <img className='w-[15rem]' src="../../public/Puebla/logo.png" alt="" />
    </div>
    </div>
