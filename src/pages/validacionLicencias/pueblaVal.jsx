...
export default function pueblaVal() {
    ...
    const folio = useParams();
      ...
      const licenciaEncontrada = licenciaPuebla.find((item) => item.folio === folio.folio);
  ...
  return (
    ...
    <img className='lg:w-[18rem] sm:w-[10rem]  h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Puebla%2Flogo.png?alt=media&token=19755382-86fd-4f11-8ac9-686345b8a182" alt="" />
    </div>
    ...
    <div className='w-full h-[5vh]  text-[#4e4e4e] flex justify-center items-center text-[1.2rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
    ...
    <p className='text-[#4e4e4e]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#4e4e4e]'>FOLIO</p>
    ...
    <p className='text-[#4e4e4e]'>TIPO</p>
    ...
    <p className='text-[#4e4e4e]'>RFC / CURP</p>
    ...
    <p className='text-[#4e4e4e]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#4e4e4e]'>VIGENCIA</p>
    ...
    <div className='bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Puebla%2F2.png?alt=media&token=baa3fcd8-ef82-42e2-91df-eeb7d29cbb24")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <p className='text-[#4e4e4e] lg:text-[1.5rem]'>Validación de licencias de conducir</p>
