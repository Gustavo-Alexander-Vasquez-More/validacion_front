...
export default function zacatecasVal() {
  ...
  return (
    ...
    <p className='text-[#4a4a4b]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#4a4a4b]'>FOLIO</p>
    ...
    <p className='text-[#4a4a4b]'>TIPO</p>
    ...
    <p className='text-[#4a4a4b]'>RFC / CURP</p>
    ...
    <p className='text-[#4a4a4b]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#4a4a4b]'>VIGENCIA</p>
