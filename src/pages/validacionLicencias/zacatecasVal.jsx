...
export default function zacatecasVal() {
  ...
  return (
    ...
    <img className='lg:w-[15rem] sm:w-[10rem]  h-[5rem]' src="../../public/Zacatecas/logo.png" alt="" />
    </div>
    ...
    <div className='bg-[url("/public/Zacatecas/2.png")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <img className='w-[15rem]' src="../../public/Zacatecas/logo.png" alt="" />
    </div>
    </div>
