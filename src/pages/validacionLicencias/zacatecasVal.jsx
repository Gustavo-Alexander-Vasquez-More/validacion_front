...
export default function zacatecasVal() {
  ...
  console.log(licenciaZacatecas);
    const licenciaEncontrada = licenciaZacatecas.find((item) => item.folio === folio.folio);
  ...
  return (
    ...
    <img className='lg:w-[15rem] sm:w-[10rem]  h-[5rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Zacatecas%2Flogo.png?alt=media&token=a5bd3d37-3874-468b-a3ca-cd7d897da6e4" alt="" />
    </div>
    ...
    <div className='w-full h-[5vh]  text-[#4a4a4b] flex justify-center items-center text-[1.2rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
    ...
    <p className='text-[#4a4a4b] sm:text-[1rem] text-[0.8rem]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#4a4a4b] sm:text-[1rem] text-[0.8rem]'>FOLIO</p>
    ...
    <p className='text-[#4a4a4b] sm:text-[1rem] text-[0.8rem]'>TIPO</p>
    ...
    <p className='text-[#4a4a4b] sm:text-[1rem] text-[0.8rem]'>RFC / CURP</p>
    ...
    <p className='text-[#4a4a4b] sm:text-[1rem] text-[0.8rem]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#4a4a4b] sm:text-[1rem] text-[0.8rem]'>VIGENCIA</p>
    ...
    <div className='bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Zacatecas%2F2.png?alt=media&token=5a76f14a-54e7-4c77-b4be-43b3f278cbd8")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <p className='text-[#4a4a4b] lg:text-[1.5rem]'>Validación de licencias de conducir</p>
    <img className='w-[15rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Zacatecas%2Flogo.png?alt=media&token=a5bd3d37-3874-468b-a3ca-cd7d897da6e4" alt="" />
    </div>
    </div>
    {token && (
