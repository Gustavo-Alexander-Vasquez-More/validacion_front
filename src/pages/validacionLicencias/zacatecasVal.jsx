...
export default function zacatecasVal() {
  ...
  return (
    ...
    <img className='w-[15rem] h-[8rem]' src="../../public/Zacatecas/logo.png" alt="" />
    </div>
    ...
    <div className='w-full h-[5vh]  text-[#525151] flex justify-center items-center text-[1.2rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
    ...
    <p className='text-[#525151]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#525151]'>FOLIO / TIPO</p>
    ...
    <p className='text-[#525151]'>TIPO</p>
    ...
    <p className='text-[#525151]'>RFC / CURP</p>
    ...
    <p className='text-[#525151]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#525151]'>VIGENCIA</p>
    ...
    <p className='text-[#525151] text-[2rem]'>Validación de licencias de conducir</p>
    <img className='w-[9rem]' src="../../public/Zacatecas/logo.png" alt="" />
    </div>
    </div>
