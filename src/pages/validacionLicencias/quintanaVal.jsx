...
export default function quintanaVal() {
  ...
  const folio = useParams();
    ...
    const licenciaEncontrada = licenciaQuintana.find((item) => item.folio === folio.folio);
  ...
  return (
    ...
    <img className='w-[20rem] h-[7rem]' src="../../public/QuintanaRoo/logo.png" alt="" />
    </div>
    ...
    <div className='w-full h-[5vh]  text-[#cf4f64] flex justify-center items-center text-[1.2rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
    ...
    <p className='text-[#cf4f64]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#cf4f64]'>FOLIO / TIPO</p>
    ...
    <p className='text-[#cf4f64]'>TIPO</p>
    ...
    <p className='text-[#cf4f64]'>RFC / CURP</p>
    ...
    <p className='text-[#cf4f64]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#cf4f64]'>VIGENCIA</p>
    ...
    <div className='bg-[url("/public/QuintanaRoo/2.png")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <p className='text-[#cf4f64] text-[2rem]'>Validación de licencias de conducir</p>
    <img className='w-[15rem]' src="../../public/QuintanaRoo/logo.png" alt="" />
    </div>
    </div>
