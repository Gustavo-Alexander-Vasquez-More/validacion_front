...
export default function quintanaVal() {
  ...
  return (
    ...
    <img className='lg:w-[15rem] sm:w-[10rem]  h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/QuintanaRoo%2Flogo.png?alt=media&token=dd5b990f-79f2-4a2d-a3ee-74fabeb8023f" alt="" />
    </div>
