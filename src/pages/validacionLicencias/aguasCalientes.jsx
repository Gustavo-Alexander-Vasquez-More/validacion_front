...
function formatearFecha(fechaISO8601) {
  ...
  <div className='w-full h-screen  px-[8rem]'>
    ...
    <p className='text-[#4b4b9b]'>FOLIO</p>
    ...
    <p className='text-[#4b4b9b]'>TIPO</p>
    ...
    <p className='text-[#4b4b9b]'>RFC / CURP</p>
    ...
    <p className='text-[#4b4b9b]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#4b4b9b]'>VIGENCIA</p>
