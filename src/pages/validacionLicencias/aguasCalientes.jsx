...
const folio = useParams();
  ...
  const licenciaEncontrada = licenciaAguas.find((item) => item.folio === folio.folio);
...
function formatearFecha(fechaISO8601) {
  ...
  <div className='w-full h-screen  sm:px-[8rem] flex flex-col items-center sm:block'>
    ...
    <img className='lg:w-[15rem] sm:w-[10rem]  h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/AguasCalientes%2Flogo.png?alt=media&token=6ff8f48b-71b1-485f-81a7-8f297923b129" alt="" />
    </div>
    ...
    <div className='w-full h-[5vh]  text-[#4b4b9b] flex justify-center items-center sm:text-[1.2rem] text-[0.8rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
    ...
    <p className='text-[#4b4b9b] sm:text-[1rem] text-[0.8rem]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#4b4b9b] sm:text-[1rem] text-[0.8rem]'>FOLIO</p>
    ...
    <p className='text-[#4b4b9b] sm:text-[1rem] text-[0.8rem]'>TIPO</p>
    ...
    <p className='text-[#4b4b9b] sm:text-[1rem] text-[0.8rem]'>RFC / CURP</p>
    ...
    <p className='text-[#4b4b9b] sm:text-[1rem] text-[0.8rem]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#4b4b9b] sm:text-[1rem] text-[0.8rem]'>VIGENCIA</p>
    ...
    <div className='bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/AguasCalientes%2F2.png?alt=media&token=216edd9a-ddec-45a2-a831-b0370cbf2bd8")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <p className='text-[#4b4b9b] lg:text-[1.5rem]'>Validación de licencias de conducir</p>
