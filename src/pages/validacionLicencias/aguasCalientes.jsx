...
useEffect(() => {
  ...
  const licenciaAguas2 = allLicencia?.filter(licencia => licencia.estado_id.nombre === 'Aguascalientes');
  const licenciaEncontrada = licenciaAguas?.find((item) => item.folio === folio);
  const licenciaEncontradaAll = licenciaAguas2?.find((item) => item.folio === folio);
