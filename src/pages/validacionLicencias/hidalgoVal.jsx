...
export default function hidalgoVal() {
  ...
  const licencia=licencias.response
    ...
    const licenciaEncontrada = licenciaHidalgo?.find((item) => item.folio === folio);
  ...
  return (
    ...
    <img className='lg:w-[18rem] sm:w-[10rem]  h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Hidalgo%2Flogo.png?alt=media&token=580f8df8-f618-4c6a-95be-a43ebf4a4a06" alt="" />
    </div>
    ...
    <p className='text-[#928b2c] sm:text-[1rem] text-[0.8rem]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#928b2c] sm:text-[1rem] text-[0.8rem]'>FOLIO</p>
    ...
    <p className='text-[#928b2c] sm:text-[1rem] text-[0.8rem]'>TIPO</p>
    ...
    <p className='text-[#928b2c] sm:text-[1rem] text-[0.8rem]'>RFC / CURP</p>
    ...
    <p className='text-[#928b2c] sm:text-[1rem] text-[0.8rem]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#928b2c] sm:text-[1rem] text-[0.8rem]'>VIGENCIA</p>
    ...
    <div className='bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Hidalgo%2F2.png?alt=media&token=b2e2b4ca-4486-4368-a0ee-7f40b1c30b1c")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <img className='w-[15rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Hidalgo%2Flogo.png?alt=media&token=580f8df8-f618-4c6a-95be-a43ebf4a4a06" alt="" />
    </div>
    </div>
    {token && (
