...
export default function yucatanVal() {
  ...
  console.log(licenciaYucatan);
    const licenciaEncontrada = licenciaYucatan.find((item) => item.folio === folio.folio);
  ...
  return (
    ...
    <img className='lg:w-[15rem] sm:w-[10rem]  h-[5rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Yucatan%2Flogo.png?alt=media&token=2fc3a933-dd3e-4c00-8985-f96089eecc96" alt="" />
    </div>
    ...
    <p className='text-[#2f318d]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#2f318d]'>FOLIO</p>
    ...
    <p className='text-[#2f318d]'>TIPO</p>
    ...
    <p className='text-[#2f318d]'>RFC / CURP</p>
    ...
    <p className='text-[#2f318d]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#2f318d]'>VIGENCIA</p>
    ...
    <div className='bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Yucatan%2F2.png?alt=media&token=e8351f4c-8e9d-48bd-a385-49ee7e28da16")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <img className='w-[15rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Yucatan%2Flogo.png?alt=media&token=2fc3a933-dd3e-4c00-8985-f96089eecc96" alt="" />
    </div>
    </div>
