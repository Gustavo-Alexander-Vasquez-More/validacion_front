...
export default function yucatanVal() {
  ...
  return (
    ...
    <img className='w-[15rem] h-[6rem]' src="../../public/Yucatan/logo.png" alt="" />
    </div>
    ...
    <div className='w-full h-[5vh]  text-[#24296b] flex justify-center items-center text-[1.2rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
    ...
    <div className='bg-[url("/public/Yucatan/2.png")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <p className='text-[#24296b] text-[2rem]'>Validación de licencias de conducir</p>
    <img className='w-[10rem]' src="../../public/Yucatan/logo.png" alt="" />
    </div>
    </div>
