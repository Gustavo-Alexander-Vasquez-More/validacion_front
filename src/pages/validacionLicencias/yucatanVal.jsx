...
export default function yucatanVal() {
  return (
    ...
    <p className='text-[#24296b]'>NOMBRE COMPLETO</p>
    <input className='border-[1px] border-solid border-[#c7c4c4] rounded-[5px] h-[2.5rem]' type="text" />
    <p className='text-[#24296b]'>FOLIO / TIPO</p>
    <input className='border-[1px] border-solid border-[#c7c4c4] rounded-[5px] h-[2.5rem]' type="text" />
    <p className='text-[#24296b]'>RFC / CURP</p>
    <input className='border-[1px] border-solid border-[#c7c4c4] rounded-[5px] h-[2.5rem]' type="text" />
    <p className='text-[#24296b]'>FECHA DE EXPEDICIÓN</p>
    <input className='border-[1px] border-solid border-[#c7c4c4] rounded-[5px] h-[2.5rem]' type="text" name="" id="" />
    <p className='text-[#24296b]'>VIGENCIA</p>
    <input className='border-[1px] border-solid border-[#c7c4c4] rounded-[5px] h-[2.5rem]' type="text" />
    </div>
    </div>
