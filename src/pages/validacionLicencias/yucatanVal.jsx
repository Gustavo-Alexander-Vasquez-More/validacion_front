...
export default function yucatanVal() {
  ...
  return (
    ...
    <p className='text-[#2f318d] sm:text-[1rem] text-[0.8rem]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#2f318d] sm:text-[1rem] text-[0.8rem]'>FOLIO</p>
    ...
    <p className='text-[#2f318d] sm:text-[1rem] text-[0.8rem]'>TIPO</p>
    ...
    <p className='text-[#2f318d] sm:text-[1rem] text-[0.8rem]'>RFC / CURP</p>
    ...
    <p className='text-[#2f318d] sm:text-[1rem] text-[0.8rem]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#2f318d] sm:text-[1rem] text-[0.8rem]'>VIGENCIA</p>
