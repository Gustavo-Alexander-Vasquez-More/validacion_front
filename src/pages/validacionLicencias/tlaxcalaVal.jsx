...
export default function tlaxcalaVal() {
  ...
  return (
    ...
    <img className='lg:w-[15rem] sm:w-[10rem]  h-[5rem]' src="../../public/Tlaxcala/logo.png" alt="" />
    </div>
    ...
    <div className='bg-[url("/public/Tlaxcala/2.png")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <img className='w-[7rem]' src="../../public/Tlaxcala/logo.png" alt="" />
    </div>
    </div>
