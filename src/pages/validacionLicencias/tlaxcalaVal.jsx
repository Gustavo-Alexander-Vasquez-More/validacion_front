...
export default function tlaxcalaVal() {
  ...
  return (
    ...
    <p className='text-[#2f3d8d]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#2f3d8d]'>FOLIO</p>
    ...
    <p className='text-[#2f3d8d]'>TIPO</p>
    ...
    <p className='text-[#2f3d8d]'>RFC / CURP</p>
    ...
    <p className='text-[#2f3d8d]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#2f3d8d]'>VIGENCIA</p>
