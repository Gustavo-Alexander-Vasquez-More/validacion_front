...
export default function tlaxcalaVal() {
  ...
  return (
    ...
    <img className='w-[15rem] h-[8rem]' src="../../public/Tlaxcala/logo.png" alt="" />
    </div>
    ...
    <div className='w-full h-[5vh]  text-[#282770] flex justify-center items-center text-[1.2rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
    ...
    <p className='text-[#282770]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#282770]'>FOLIO / TIPO</p>
    ...
    <p className='text-[#282770]'>TIPO</p>
    ...
    <p className='text-[#282770]'>RFC / CURP</p>
    ...
    <p className='text-[#282770]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#282770]'>VIGENCIA</p>
    ...
    <p className='text-[#282770] text-[2rem]'>Validación de licencias de conducir</p>
    <img className='w-[9rem]' src="../../public/Tlaxcala/logo.png" alt="" />
    </div>
    </div>
