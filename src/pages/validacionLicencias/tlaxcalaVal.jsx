...
export default function tlaxcalaVal() {
  ...
  console.log(licenciaTlaxcala);
    const licenciaEncontrada = licenciaTlaxcala.find((item) => item.folio === folio.folio);
  ...
  return (
    ...
    <img className='lg:w-[15rem] sm:w-[10rem]  h-[5rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Tlaxcala%2Flogo.png?alt=media&token=8d9d7c9a-8cbe-49ae-ad82-473decf72668" alt="" />
    </div>
    ...
    <div className='w-full h-[5vh]  text-[#2f3d8d] flex justify-center items-center text-[1.2rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
    ...
    <p className='text-[#2f3d8d] sm:text-[1rem] text-[0.8rem]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#2f3d8d] sm:text-[1rem] text-[0.8rem]'>FOLIO</p>
    ...
    <p className='text-[#2f3d8d] sm:text-[1rem] text-[0.8rem]'>TIPO</p>
    ...
    <p className='text-[#2f3d8d] sm:text-[1rem] text-[0.8rem]'>RFC / CURP</p>
    ...
    <p className='text-[#2f3d8d] sm:text-[1rem] text-[0.8rem]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#2f3d8d] sm:text-[1rem] text-[0.8rem]'>VIGENCIA</p>
    ...
    <div className='bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Tlaxcala%2F2.png?alt=media&token=767060e4-c728-44a9-8153-58b5402d0182")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <p className='text-[#2f3d8d] lg:text-[1.5rem]'>Validación de licencias de conducir</p>
    <img className='w-[7rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Tlaxcala%2Flogo.png?alt=media&token=8d9d7c9a-8cbe-49ae-ad82-473decf72668" alt="" />
    </div>
    </div>
