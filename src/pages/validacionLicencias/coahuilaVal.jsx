...
export default function coahuilaVal() {
  ...
  const folio = useParams();
    ...
    const licenciaEncontrada = licenciaCoahuila.find((item) => item.folio === folio.folio);
  ...
  return (
    ...
    <img className='lg:w-[18rem] sm:w-[10rem] w-[15rem] h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Coahuila%2Flogo.png?alt=media&token=4fa6156b-cf24-4180-ac88-f6e8624879e4" alt="" />
    </div>
    ...
    <div className='w-full h-[5vh]  text-[#648d2f] flex justify-center items-center text-[1.2rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
    ...
    <p className='text-[#648d2f] sm:text-[1rem] text-[0.8rem]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#648d2f] sm:text-[1rem] text-[0.8rem]'>FOLIO</p>
    ...
    <p className='text-[#648d2f] sm:text-[1rem] text-[0.8rem]'>TIPO</p>
    ...
    <p className='text-[#648d2f] sm:text-[1rem] text-[0.8rem]'>RFC / CURP</p>
    ...
    <p className='text-[#648d2f] sm:text-[1rem] text-[0.8rem]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#648d2f] sm:text-[1rem] text-[0.8rem]'>VIGENCIA</p>
    ...
    <div className='bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Coahuila%2F2.png?alt=media&token=fd1d6034-4726-4e90-834e-2f766c83b85d")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <p className='text-[#648d2f] lg:text-[1.5rem]'>Validación de licencias de conducir</p>
    <img className='w-[15rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Coahuila%2Flogo.png?alt=media&token=4fa6156b-cf24-4180-ac88-f6e8624879e4" alt="" />
    </div>
    </div>
