...
export default function coahuilaVal() {
  ...
  return (
    ...
    <img className='lg:w-[18rem] sm:w-[10rem]  h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Coahuila%2Flogo.png?alt=media&token=4fa6156b-cf24-4180-ac88-f6e8624879e4" alt="" />
    </div>
    ...
    <p className='text-[#648d2f]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#648d2f]'>FOLIO</p>
    ...
    <p className='text-[#648d2f]'>TIPO</p>
    ...
    <p className='text-[#648d2f]'>RFC / CURP</p>
    ...
    <p className='text-[#648d2f]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#648d2f]'>VIGENCIA</p>
