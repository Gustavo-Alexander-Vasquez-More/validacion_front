...
export default function coahuilaVal() {
  ...
  return (
    ...
    <img className='w-[20rem] h-[7rem]' src="../../public/Coahuila/logo.png" alt="" />
    </div>
    ...
    <div className='w-full h-[5vh]  text-[#44772c] flex justify-center items-center text-[1.2rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
    ...
    <p className='text-[#44772c]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#44772c]'>FOLIO / TIPO</p>
    ...
    <p className='text-[#44772c]'>TIPO</p>
    ...
    <p className='text-[#44772c]'>RFC / CURP</p>
    ...
    <p className='text-[#44772c]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#44772c]'>VIGENCIA</p>
    ...
    <p className='text-[#44772c] text-[2rem]'>Validación de licencias de conducir</p>
