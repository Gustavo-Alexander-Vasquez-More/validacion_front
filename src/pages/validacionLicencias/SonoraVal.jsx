...
export default function Sonora() {
  ...
  return (
    ...
    <img className='lg:w-[15rem] sm:w-[10rem] w-[12rem] h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Sonora%2Flogo.png?alt=media&token=c4ab767c-11ac-40d1-bea9-c674a66e97c5" alt="" />
    </div>
    ...
    <div className='bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Sonora%2F2.png?alt=media&token=1a7f0c72-4c62-4e19-9697-26b22732a868")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <img className='w-[15rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Sonora%2Flogo.png?alt=media&token=c4ab767c-11ac-40d1-bea9-c674a66e97c5" alt="" />
    </div>
    </div>
