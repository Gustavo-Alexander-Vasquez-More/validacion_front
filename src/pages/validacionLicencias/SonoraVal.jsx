...
export default function Sonora() {
  ...
  return (
    ...
    <img className='w-[20rem] h-[8rem]' src="../../public/Sonora/logo.png" alt="" />
    </div>
    ...
    <div className='bg-[url("/public/Sonora/2.png")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <img className='w-[9rem]' src="../../public/Sonora/logo.png" alt="" />
    </div>
    </div>
