...
export default function guanajuatoVal() {
  ...
  const licencia=licencias.response
      ...
      const licenciaEncontrada = licenciaGuanajuato?.find((item) => item.folio === folio);
  ...
  return (
    ...
    <img className='lg:w-[18rem] sm:w-[10rem] w-[10rem] h-[5rem] sm:h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Guanajuato%2Flogo.png?alt=media&token=be6712fa-c5af-40c3-a304-48c4d675fe69" alt="" />
    </div>
    ...
    <p className='text-[#2c3f92] sm:text-[1rem] text-[0.8rem]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#2c3f92] sm:text-[1rem] text-[0.8rem]'>FOLIO</p>
    ...
    <p className='text-[#2c3f92] sm:text-[1rem] text-[0.8rem]'>TIPO</p>
    ...
    <p className='text-[#2c3f92] sm:text-[1rem] text-[0.8rem]'>RFC / CURP</p>
    ...
    <p className='text-[#2c3f92] sm:text-[1rem] text-[0.8rem]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#2c3f92] sm:text-[1rem] text-[0.8rem]'>VIGENCIA</p>
