...
export default function chihuahuaVal() {
  return (
    ...
    <p className='text-[#40399e]'>NOMBRE COMPLETO</p>
    <input className='border-[1px] border-solid border-[#c7c4c4] rounded-[5px] h-[2.5rem]' type="text" />
    <p className='text-[#40399e]'>FOLIO / TIPO</p>
    <input className='border-[1px] border-solid border-[#c7c4c4] rounded-[5px] h-[2.5rem]' type="text" />
    <p className='text-[#40399e]'>RFC / CURP</p>
    <input className='border-[1px] border-solid border-[#c7c4c4] rounded-[5px] h-[2.5rem]' type="text" />
    <p className='text-[#40399e]'>FECHA DE EXPEDICIÓN</p>
    <input className='border-[1px] border-solid border-[#c7c4c4] rounded-[5px] h-[2.5rem]' type="text" name="" id="" />
    <p className='text-[#40399e]'>VIGENCIA</p>
    <input className='border-[1px] border-solid border-[#c7c4c4] rounded-[5px] h-[2.5rem]' type="text" />
    </div>
    </div>
