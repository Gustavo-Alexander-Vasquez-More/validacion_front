...
export default function chihuahuaVal() {
  ...
  return (
    ...
    <img className='lg:w-[15rem] sm:w-[10rem] w-[14rem]  h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Chihuahua%2Flogo.png?alt=media&token=fd2f81ab-2b10-4fca-bd33-f96624c44afd" alt="" />
    </div>
