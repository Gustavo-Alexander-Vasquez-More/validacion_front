...
export default function chihuahuaVal() {
  ...
  return (
    ...
    <img className='w-[20rem] h-[6rem]' src="../../public/Chihuahua/logo.png" alt="" />
    </div>
    ...
    <div className='w-full h-[5vh]  text-[#40399e] flex justify-center items-center text-[1.2rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
    ...
    <p className='text-[#252d75]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#252d75]'>FOLIO / TIPO</p>
    ...
    <p className='text-[#252d75]'>TIPO</p>
    ...
    <p className='text-[#252d75]'>RFC / CURP</p>
    ...
    <p className='text-[#252d75]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#252d75]'>VIGENCIA</p>
    ...
    <p className='text-[#40399e] text-[2rem]'>Validación de licencias de conducir</p>
    <img className='w-[15rem]' src="../../public/Chihuahua/logo.png" alt="" />
    </div>
    </div>
