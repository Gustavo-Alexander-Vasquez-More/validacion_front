...
export default function chihuahuaVal() {
  ...
  const folio = useParams();
    ...
    const licenciaEncontrada = licenciaChihuahua.find((item) => item.folio === folio.folio);
  ...
  return (
    ...
    <img className='lg:w-[15rem] sm:w-[10rem]  h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Chihuahua%2Flogo.png?alt=media&token=fd2f81ab-2b10-4fca-bd33-f96624c44afd" alt="" />
    </div>
    ...
    <div className='w-full h-[5vh]  text-[#2f388d] flex justify-center items-center text-[1.2rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
    ...
    <p className='text-[#2f388d]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#2f388d]'>FOLIO</p>
    ...
    <p className='text-[#2f388d]'>TIPO</p>
    ...
    <p className='text-[#2f388d]'>RFC / CURP</p>
    ...
    <p className='text-[#2f388d]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#2f388d]'>VIGENCIA</p>
    ...
    <div className='bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Chihuahua%2F2.png?alt=media&token=f053ebc6-3bf8-4ccc-b2e1-ae29eea6e806")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    <div className='w-[45%] h-[80vh]'></div>
    <div className='absolute lg:w-[40%] sm:w-[35%] lg:h-[30vh] sm:h-[29vh] bg-[white] lg:left-[50%] lg:bottom-[46.5%] sm:left-[50%] sm:bottom-[46.7%] lg:px-[3rem] sm:px-[2rem] border-[1px] border-solid border-[#c7c4c4] font-semibold flex flex-col justify-around py-[2rem] items-center text-center animate-rotate-x rounded-[5px]'>
    <p className='text-[#2f388d] lg:text-[1.5rem]'>Validación de licencias de conducir</p>
    <img className='w-[12rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Chihuahua%2Flogo.png?alt=media&token=fd2f81ab-2b10-4fca-bd33-f96624c44afd" alt="" />
    </div>
    </div>
