...
export default function chihuahuaVal() {
  ...
  return (
    ...
    <img className='lg:w-[15rem] sm:w-[10rem]  h-[6rem]' src="../../public/Chihuahua/logo.png" alt="" />
    </div>
    ...
    <div className='bg-[url("/public/Chihuahua/2.png")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <img className='w-[12rem]' src="../../public/Chihuahua/logo.png" alt="" />
    </div>
    </div>
