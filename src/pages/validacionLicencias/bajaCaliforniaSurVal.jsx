...
export default function bajaCaliforniaSurVal() {
    ...
    const folio = useParams();
      ...
      const licenciaEncontrada = licenciaBajaCalSur.find((item) => item.folio === folio.folio);
  ...
  return (
    ...
    <img className='lg:w-[18rem] sm:w-[10rem]  h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/BajaCaliforniaSur%2Flogo.png?alt=media&token=109b74af-8ae8-46b1-b3cf-6fa97c630122" alt="" />
    </div>
    ...
    <p className='text-[#8d2f4b]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#8d2f4b]'>FOLIO</p>
    ...
    <p className='text-[#8d2f4b]'>TIPO</p>
    ...
    <p className='text-[#8d2f4b]'>RFC / CURP</p>
    ...
    <p className='text-[#8d2f4b]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#8d2f4b]'>VIGENCIA</p>
    ...
    <div className='bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/BajaCaliforniaSur%2F2.png?alt=media&token=919fc6b2-9918-4b76-ab12-dc2bca17cfaa")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <img className='w-[15rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/BajaCaliforniaSur%2Flogo.png?alt=media&token=109b74af-8ae8-46b1-b3cf-6fa97c630122" alt="" />
    </div>
    </div>
