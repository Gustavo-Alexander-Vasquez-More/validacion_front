...
export default function bajaCaliforniaSurVal() {
  ...
  return (
    ...
    <img className='w-[20rem] h-[6rem]' src="../../public/BajaCaliforniaSur/logo.png" alt="" />
    </div>
    ...
    <div className='w-full h-[5vh]  text-[#9b4b4b] flex justify-center items-center text-[1.2rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
    ...
    <p className='text-[#9b4b4b]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#9b4b4b]'>FOLIO</p>
    ...
    <p className='text-[#9b4b4b]'>TIPO</p>
    ...
    <p className='text-[#9b4b4b]'>RFC / CURP</p>
    ...
    <p className='text-[#9b4b4b]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#9b4b4b]'>VIGENCIA</p>
    ...
    <div className='bg-[url("/public/BajaCaliforniaSur/2.png")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <p className='text-[#9b4b4b] text-[2rem]'>Validación de licencias de conducir</p>
    <img className='w-[15rem]' src="../../public/BajaCaliforniaSur/logo.png" alt="" />
    </div>
    </div>
