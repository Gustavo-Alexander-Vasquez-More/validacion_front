...
export default function bajaCaliforniaSurVal() {
  ...
  const licenciaBajaCalSur2=allLicencia?.filter(licencia=>licencia.estado_id.nombre === 'Baja California Sur')    
  const licenciaEncontrada = licenciaBajaCalSur?.find((item) => item.folio === folio);
  const licenciaEncontradaAll = licenciaBajaCalSur2?.find((item) => item.folio === folio);  
  ...
  return (
    ...
    <img className='lg:w-[18rem] sm:w-[15rem]  h-[6rem] w-[15rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/BajaCaliforniaSur%2Flogo.png?alt=media&token=109b74af-8ae8-46b1-b3cf-6fa97c630122" alt="" />
    </div>
