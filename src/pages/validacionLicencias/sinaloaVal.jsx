...
export default function sinaloaVal() {
  ...
  return (
    ...
    <img className='lg:w-[15rem] sm:w-[10rem]  h-[6rem]' src="../../public/Sinaloa/logo.png" alt="" />
    </div>
    ...
    <div className='bg-[url("/public/Sinaloa/2.png")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <img className='w-[15rem]' src="../../public/Sinaloa/logo.png" alt="" />
    </div>
    </div>
