...
export default function nayaritVal() {
  ...
  return (
    ...
    <img className='lg:w-[18rem] sm:w-[10rem]  h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Nayarit%2Flogo.png?alt=media&token=5f6364e7-360d-4cff-b7cb-00d5e20f94a5" alt="" />
    </div>
