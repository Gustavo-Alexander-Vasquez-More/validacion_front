...
export default function nayaritVal() {
  ...
  const folio = useParams();
    ...
    const licenciaEncontrada = licenciaNayarit.find((item) => item.folio === folio.folio);
  ...
  return (
    ...
    <img className='lg:w-[18rem] sm:w-[15rem] w-[15rem] h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Nayarit%2Flogo.png?alt=media&token=5f6364e7-360d-4cff-b7cb-00d5e20f94a5" alt="" />
    </div>
    ...
    <div className='bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Nayarit%2F2.png?alt=media&token=15581a82-0375-4e16-872e-100e1a233c7a")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <img className='w-[15rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Nayarit%2Flogo.png?alt=media&token=5f6364e7-360d-4cff-b7cb-00d5e20f94a5" alt="" />
    </div>
    </div>
