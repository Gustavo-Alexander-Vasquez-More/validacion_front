...
export default function bajaCaliforniaNorteVal() {
  ...
  const licenciaBajaCalNor=licencia?.filter(licencia=>licencia.estado_id.nombre === 'Baja California Norte')
  const licenciaBajaCalNor2=allLicencia?.filter(licencia=>licencia.estado_id.nombre === 'Baja California Norte')
  const licenciaEncontrada = licenciaBajaCalNor?.find((item) => item.folio === folio);
  const licenciaEncontradaAll = licenciaBajaCalNor2?.find((item) => item.folio === folio);
function formatearFecha(fechaISO8601) {
  ...
  return (
    ...
    <img className='lg:w-[15rem] sm:w-[10rem]  h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/BajaCaliforniaNorte%2Flogo.png?alt=media&token=3ae04f98-5656-4fe8-88da-15449a157ab2" alt="" />
    </div>
...
<div className='border-[1px] border-solid border-[#c7c4c4] rounded-[5px] h-[2.5rem] flex items-center px-[1rem]'>
  <p className='text-[#000000]'>
    ...
    <div className='bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/BajaCaliforniaNorte%2F2.png?alt=media&token=5ca9c34d-752c-4d6f-a2ab-50207862ebea")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <img className='w-[15rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/BajaCaliforniaNorte%2Flogo.png?alt=media&token=3ae04f98-5656-4fe8-88da-15449a157ab2" alt="" />
    </div>
    </div>
    {token && (
