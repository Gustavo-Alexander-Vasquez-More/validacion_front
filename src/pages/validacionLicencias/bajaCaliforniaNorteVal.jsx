...
function formatearFecha(fechaISO8601) {
  ...
  return (
    ...
    <img className='w-[12rem] h-[6rem]' src="../../public/BajaCaliforniaNorte/logo.png" alt="" />
    </div>
    ...
    <div className='bg-[url("/public/BajaCaliforniaNorte/2.png")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <img className='w-[15rem]' src="../../public/BajaCaliforniaNorte/logo.png" alt="" />
    </div>
    </div>
