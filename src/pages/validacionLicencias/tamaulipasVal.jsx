...
export default function tamaulipasVal() {
  ...
  console.log(licenciaTamaulipas);
    const licenciaEncontrada = licenciaTamaulipas.find((item) => item.folio === folio.folio);
  ...
  return (
    ...
    <img className='lg:w-[15rem] sm:w-[10rem]  h-[6rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Tamaulipas%2Flogo.png?alt=media&token=3c293399-737f-4c54-8baf-8056032ff6a5" alt="" />
    </div>
    ...
    <p className='text-[#8d2f3b] sm:text-[1rem] text-[0.8rem]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#8d2f3b] sm:text-[1rem] text-[0.8rem]'>FOLIO</p>
    ...
    <p className='text-[#8d2f3b] sm:text-[1rem] text-[0.8rem]'>TIPO</p>
    ...
    <p className='text-[#8d2f3b] sm:text-[1rem] text-[0.8rem]'>RFC / CURP</p>
    ...
    <p className='text-[#8d2f3b] sm:text-[1rem] text-[0.8rem]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#8d2f3b] sm:text-[1rem] text-[0.8rem]'>VIGENCIA</p>
    ...
    <div className='bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Tamaulipas%2F2.png?alt=media&token=eaf775c9-f4a9-465b-b686-733f4c70bac4")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <img className='w-[15rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Tamaulipas%2Flogo.png?alt=media&token=3c293399-737f-4c54-8baf-8056032ff6a5" alt="" />
    </div>
    </div>
    {token && (
