...
export default function tamaulipasVal() {
  ...
  return (
    ...
    <img className='w-[15rem] h-[8rem]' src="../../public/Tamaulipas/logo.png" alt="" />
    </div>
    ...
    <p className='text-[#7c2a2a]'>TIPO</p>
    ...
    <div className='bg-[url("/public/Tamaulipas/2.png")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <img className='w-[9rem]' src="../../public/Tamaulipas/logo.png" alt="" />
    </div>
    </div>
