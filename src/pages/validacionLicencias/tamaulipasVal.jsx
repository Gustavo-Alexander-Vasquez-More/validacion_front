...
export default function tamaulipasVal() {
  ...
  useEffect(() => {
    ...
    const licenciaTamaulipas2=allLicencia?.filter(licencia=>licencia.estado_id.nombre === 'Tamaulipas')
    const licenciaEncontrada = licenciaTamaulipas?.find((item) => item.folio === folio);
    const licenciaEncontradaAll = licenciaTamaulipas2.find((item) => item.folio === folio);
