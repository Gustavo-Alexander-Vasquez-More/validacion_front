...
export default function veracruzVal() {
  ...
  return (
    ...
    <img className='w-[15rem] h-[8rem]' src="../../public/Veracruz/logo.png" alt="" />
    </div>
    ...
    <div className='w-full h-[5vh]  text-[#702745] flex justify-center items-center text-[1.2rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
    ...
    <p className='text-[#702745]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#702745]'>FOLIO / TIPO</p>
    ...
    <p className='text-[#702745]'>TIPO</p>
    ...
    <p className='text-[#702745]'>RFC / CURP</p>
    ...
    <p className='text-[#702745]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#702745]'>VIGENCIA</p>
    ...
    <div className='bg-[url("/public/Veracruz/2.png")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <p className='text-[#702745] text-[2rem]'>Validación de licencias de conducir</p>
    <img className='w-[9rem]' src="../../public/Veracruz/logo.png" alt="" />
    </div>
    </div>
