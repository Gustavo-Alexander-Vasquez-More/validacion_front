...
export default function veracruzVal() {
  ...
  console.log(licenciaVeracruz);
    const licenciaEncontrada = licenciaVeracruz.find((item) => item.folio === folio.folio);
  ...
  return (
    ...
    <img className='lg:w-[15rem] sm:w-[10rem]  h-[5rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Veracruz%2Flogo.png?alt=media&token=e1e00656-3ec9-49d9-9b9a-4bb3ffaec8d7" alt="" />
    </div>
    ...
    <div className='bg-[url("https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Veracruz%2F2.png?alt=media&token=f721bb25-c3be-420b-80a8-04f42f2d371d")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <img className='w-[15rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Veracruz%2Flogo.png?alt=media&token=e1e00656-3ec9-49d9-9b9a-4bb3ffaec8d7" alt="" />
    </div>
    </div>
