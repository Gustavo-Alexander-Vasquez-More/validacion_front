...
export default function nuevoLeonVal() {
  ...
  return (
    ...
    <img className='lg:w-[18rem] sm:w-[10rem]  h-[6rem]' src="../../public/NuevoLeon/logo.png" alt="" />
    </div>
    ...
    <p className='text-[#8f962e]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#8f962e]'>FOLIO</p>
    ...
    <p className='text-[#8f962e]'>TIPO</p>
    ...
    <p className='text-[#8f962e]'>RFC / CURP</p>
    ...
    <p className='text-[#8f962e]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#8f962e]'>VIGENCIA</p>
