...
export default function nuevoLeonVal() {
  ...
  return (
    ...
    <img className='w-[20rem] h-[7rem]' src="../../public/NuevoLeon/logo.png" alt="" />
    </div>
    ...
    <div className='w-full h-[5vh]  text-[#cfb14f] flex justify-center items-center text-[1.2rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
    ...
    <p className='text-[#cfb14f]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#cfb14f]'>FOLIO / TIPO</p>
    ...
    <p className='text-[#cfb14f]'>TIPO</p>
    ...
    <p className='text-[#cfb14f]'>RFC / CURP</p>
    ...
    <p className='text-[#cfb14f]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#cfb14f]'>VIGENCIA</p>
    ...
    <div className='bg-[url("/public/NuevoLeon/2.png")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <p className='text-[#cfb14f] text-[2rem]'>Validación de licencias de conducir</p>
    <img className='w-[15rem]' src="../../public/NuevoLeon/logo.png" alt="" />
    </div>
    </div>
