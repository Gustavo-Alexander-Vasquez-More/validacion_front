...
function formatearFecha(fechaISO8601) {
  ...
  return (
    ...
    <img className='lg:w-[20rem] sm:w-[10rem] w-[13rem]  h-[5rem]' src="https://firebasestorage.googleapis.com/v0/b/validacion-de-licencias-c813d.appspot.com/o/Campeche%2Flogo.png?alt=media&token=c59505cf-cbaa-4f05-9db3-b037e87dcd36" alt="" />
    </div>
