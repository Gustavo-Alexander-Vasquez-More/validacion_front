...
function formatearFecha(fechaISO8601) {
  ...
  return (
    ...
    <img className='lg:w-[20rem] sm:w-[10rem]  h-[5rem]' src="../../public/Campeche/logo.png" alt="" />
    </div>
    ...
    <div className='w-full h-[5vh]  text-[#8d2f37] flex justify-center items-center text-[1.2rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
