...
const folio = useParams();
  ...
  const licenciaEncontrada = licenciaCampeche.find((item) => item.folio === folio.folio);
...
function formatearFecha(fechaISO8601) {
  ...
  return (
    ...
    <img className='w-[20rem] h-[5rem]' src="../../public/Campeche/logo.png" alt="" />
    </div>
    ...
    <div className='w-full h-[5vh]  text-[#a8414a] flex justify-center items-center text-[1.2rem] border-solid border-[1px] border-[#c7c4c4]'>Datos personales</div>
    ...
    <p className='text-[#a8414a]'>NOMBRE COMPLETO</p>
    ...
    <p className='text-[#a8414a]'>FOLIO / TIPO</p>
    ...
    <p className='text-[#a8414a]'>TIPO</p>
    ...
    <p className='text-[#a8414a]'>RFC / CURP</p>
    ...
    <p className='text-[#a8414a]'>FECHA DE EXPEDICIÓN</p>
    ...
    <p className='text-[#a8414a]'>VIGENCIA</p>
    ...
    <div className='bg-[url("/public/Campeche/2.png")] w-full h-[30vh] bg-contain bg-no-repeat'></div>
    </div>
    ...
    <p className='text-[#a8414a] text-[2rem]'>Validación de licencias de conducir</p>
    <img className='w-[15rem]' src="../../public/Campeche/logo.png" alt="" />
    </div>
    </div>
